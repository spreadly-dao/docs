...
**Phase 1 - SPRD Bonding**  
- Fixed bonding curve parameters required for a DAO to graduate from the curve
- Automated LP migration to Cetus for live trading
...
|---------------------|------------|-----------------|
| Spot Trading        | Whitelisted Pairs | All Pairs |
